...
@Entity								// ‘@Entity’ informa ao JPA que essa classe se trata de uma entidade JPA
@Table(name="empresa")				// ‘@Table’ permite definir o nome da tabela no banco de dados para a entidade (opcional)
