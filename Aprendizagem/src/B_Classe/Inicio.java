...
public class Inicio {
	...
	public static void destruindoObjetos() {
		...
		System.out.println("A instância originalmente indicada por carro1 pode ser destruida, pois não há referências.");
		...
		if (carro2==null)
			System.out.println("Referência de carro2 é nula");
		
		carro1 = null;
		System.out.println("A instância originalmente indicada por carro2 pode ser destruida, pois não há referências.");
	}
	...
	public static void exemploEstatico() {
		...
		System.out.println("Instância: " + novoCarro.metodoEstatico());
	}
}
