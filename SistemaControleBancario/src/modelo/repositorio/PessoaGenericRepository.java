...
public class PessoaGenericRepository extends PersistenceConfig {
	...
	public Set<Pessoa> recuperarPessoas() {
		...
		try {
			...
			Stream<Pessoa> pessoasStream = getEntityManager().createQuery("FROM " + Pessoa.class.getName() + " ORDER BY idPessoa ASC")
					.getResultStream();
