				...
				public void run() {
					...
					JedisPubSub jedisPubSub = new JedisPubSub() {
						...
						public void onUnsubscribe(String channel, int subscribedChannels) {
							System.out.println(String.format("%s deixou de escutar a estação %s", nome, channel));
						}

						@Override 
						public void onSubscribe(String channel, int subscribedChannels) {
							System.out.println(String.format("%s começou a escutar a estação %s", nome, channel));
						}

						@Override
						public void onMessage(String channel, String message) {
							System.out.println(String.format("%s está ouvindo %s na estação %s", nome, message, channel));
