...
public class GerarNovoJogador {
	...
	public void adicionarNovoJogador(String jogador) {
		...
		// Adicionar elemento em um Sorted Set
		long resultado = jedis.zadd(chave, pontuacaoInicial, jogador);

		System.out.println(String.format("Novo Jogador: %s com %.0f pontos iniciais. Resultado: %d", jogador, pontuacaoInicial, resultado));
	}
